  ...
  return (
    <div
      ...
      style={
        ...
        { gridTemplateRows: "fit-content(100%) 1fr 2fr" }
      }
    >
      ...
      <button
        ...
        className="flex items-center before:w-5 before:h-5 before:ml-1 before:mr-3 before:bg-google before:inline-block before:bg-contain before:align-middle
             p-2 text-gray-500 font-bold text-lg border rounded border-solid border-gray-500 bg-primary m-auto"
      >
        Googleで続ける
      </button>
    </div>
